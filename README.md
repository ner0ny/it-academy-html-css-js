...
&emsp;&emsp;3.1. Ваше ФИО: Иванов Иван Иванович    
&emsp;&emsp;3.2. Ваш возраст в годах: 20    
&emsp;&emsp;3.3. Ваш возраст в днях: 7300    
&emsp;&emsp;3.4. Вы уже совершеннолетний    
&emsp;&emsp;3.5. Ваш пол: мужской    
&emsp;&emsp;3.6. Вы на пенсии: нет
...
&emsp;&emsp;1.1. проверить введенные данные и вывести ошибку, если число является отрицательным или текстом, то повторить запрос о количестве ячеек снова;    
&emsp;&emsp;1.2. если введено число, удовлетворяющее предыдущим проверкам, но оно больше 10, то попросить ввести число меньше;    
&emsp;&emsp;1.3. если входные данные прошли проверку, то средствами javascript построить квадратную таблицу, где размером будет введенное пользователем число;    
&emsp;&emsp;1.4. наполнить ее текстом и стилями, чтобы итоговый результат был как на [картинке](https://prnt.sc/U240VdadnfNy)     
...
&emsp;&emsp;2.1. по клику на кнопку “Скрыть таблицу” - прячем таблицу, но не удаляем ее из DOM и делаем кнопку не активной (не кликабельной, задизейбленной), а кнопку “Показать таблицу” активной (кликабельной).    
&emsp;&emsp;2.2. по клику на кнопку “Показать таблицу” - снова отображаем таблицу на странице, а саму кнопку делаем не активной и кнопку “Скрыть таблицу” делаем активной.
